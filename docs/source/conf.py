...
# -*- coding: utf-8 -*-
#
# RADICAL-OWMS documentation build configuration file, created by
...
# built documents.
#
# The short X.Y version - get this directly from RADICAL-OWMS !
import radical.owms
version = radical.owms.short_version
# The full version, including alpha/beta/rc tags.
release = radical.owms.version
...
htmlhelp_basename = 'radical_owms_doc'
...
latex_documents = [
  ('index', 'radical_owms.tex', u'RADICAL-OWMS Documentation',
...
man_pages = [
    ('index', 'RADICAL-OWMS', u'RADICAL-OWMS Documentation',
...
texinfo_documents = [
  ('index', 'RADICAL-OWMS', u'RADICAL-OWMS Documentation',
   u'The SAGA Project', 'RADICAL-OWMS', 'Tiered Resource Overlay.',
   'Miscellaneous'),
]
