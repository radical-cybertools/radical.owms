...
setup_args = {
    ...
    'url'                : "https://www.github.com/radical-cybertools/radical.owms/",
    'license'            : "MIT",
    'keywords'           : "radical pilot job saga resource overlay",
    'classifiers'        : [
    ...
    'packages'           : [
        ...
        "radical.owms",
        "radical.owms.utils",
        "radical.owms.application",
        "radical.owms.planner",
        "radical.owms.overlay",
        "radical.owms.workload",
        "radical.owms.plugins",
        "radical.owms.plugins.planner_strategy",
        "radical.owms.plugins.planner_derive",
        "radical.owms.plugins.overlay_translator",
        "radical.owms.plugins.overlay_scheduler",
        "radical.owms.plugins.overlay_provisioner",
        "radical.owms.plugins.workload_parser",
        "radical.owms.plugins.workload_translator",
        "radical.owms.plugins.workload_expander",
        "radical.owms.plugins.workload_scheduler",
        "radical.owms.plugins.workload_dispatcher",
        "radical.owms.external",
        "radical.owms.external.bundle",
        "radical.owms.external.bundle.src",
        "radical.owms.external.bundle.src.bundle",
        "radical.owms.external.bundle.src.bundle.impl",
        "radical.owms.external.bundle.src.bundle.api",
