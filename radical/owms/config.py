...
#
# [general]
# output_directory=/Users/mark/proj/radical.owms/output
# log_level=42
# i_feel_lucky=yes
#
# [bundle]
...
class Configuration (ruc.Configurable):
    ...
    def __init__(self):
        ...
        ruc.Configurable.__init__(self, 'radical.owms')

        #ruc.Configurable.config_options (self, 'radical.owms.bundles',  _bundle_section)
        #self._cfg = self.get_config('radical.owms.engine')
        ...
        _general_section = [
        {
            ...
            'type'          : str,
            'default'       : '', # $HOME/radical.owms
            'valid_options' : '',
            'documentation' : 'radical.owms working directory',
            'env_variable'  : ''
        }, {
            # log_level
            'category'      : 'general',
        ...
        for section_name in self.compute_sections:
          ...
          # pprint.pprint(c)
          # import radical.owms
          # radical.owms._logger.debug ('endpoint: %s' % endpoint)
