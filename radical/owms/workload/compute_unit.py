...
"""
Represent a compute unit, as element of a radical.owms.Task in a radical.owms.Workload.
"""
...
class ComputeUnit (tu.Properties, tu.Timed) :
    ...
    radical.owms.  More specifically, `Task`s are decomposed into `ComputeUnit`s
    ...
    def __init__ (self, session, param=None, _native_id=None, _task=None, _pilot_id=None) :
        ...
        if  _native_id :
            ...
            self.id    = None
            descr      = radical.owms.ComputeUnitDescription ()
            reconnect  = True
        ...
        elif isinstance (param, radical.owms.ComputeUnitDescription) :
            native_id  = None
