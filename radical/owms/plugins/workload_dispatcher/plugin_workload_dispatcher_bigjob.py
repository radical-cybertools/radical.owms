...
class PLUGIN_CLASS (radical.owms.PluginBase):
    ...
    * `coordination_url`: the redis URL to be used by BigJob.  The environment
    ...
    def dispatch (self, workload, overlay) :
        ...
        for tid in workload.tasks.keys () :
            ...
            for uid in task.units.keys () :
                ...
                pilot      = radical.owms.Pilot (overlay.session, pilot_id, _instance_type='bigjob')
                ...
                for key in unit_descr :
                    ...
                    # ignore radical.owms level keys
                    if  key in ['tag'] :
                        continue
    ...
    def unit_reconnect (self, native_id) :
        ...
        radical.owms._logger.debug ("reconnect to bigjob subjob %s" % native_id)
